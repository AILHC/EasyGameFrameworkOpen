declare namespace broadcast {
     ...
     */
    class Broadcast<MsgKeyType extends broadcast.IMsgKey, ValueType = any, ResultType = any>
         ...
         * @param key
         */
        value<keyType extends keyof MsgKeyType = any>(
            key: keyType
        ): ValueType[broadcast.ToAnyIndexKey<keyType, ValueType>];
        /**
         * 销毁广播系统
    ...
    namespace broadcast {
        ...
        interface IListenerHandler<keyType extends keyof any = any, ValueType = any, ResultType = any> {
            key: keyType;
            listener: Listener<
                ValueType[ToAnyIndexKey<keyType, ValueType>],
                ResultType[ToAnyIndexKey<keyType, ResultType>]
            >;
            context?: any;
            args?: any[];
            once?: boolean;
        ...
        interface IBroadcast<MsgKeyType = any, ValueType = any, ResultType = any> {
            ...
            on<keyType extends keyof MsgKeyType = any>(
                handler:
                    | keyType
                    | IListenerHandler<keyType, ValueType, ResultType>
                    | IListenerHandler<keyType, ValueType, ResultType>[],
                listener?: Listener<
                    ValueType[ToAnyIndexKey<keyType, ValueType>],
                    ResultType[ToAnyIndexKey<keyType, ResultType>]
            ...
            broadcast<keyType extends keyof MsgKeyType = any>(
                key: keyType,
                value?: ValueType[ToAnyIndexKey<keyType, ValueType>],
                callback?: ResultCallBack<ResultType[ToAnyIndexKey<keyType, ResultType>]>,
                persistence?: boolean
            ): void;
            /**
             * 广播一条 指定 [key] 的粘性消息
