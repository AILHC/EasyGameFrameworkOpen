...
declare module '@ailhc/dpctrl-fguicc' {
	import { BinderTool } from '@ailhc/dpctrl-fguicc';
	import * as fairygui from 'fairygui-cc'; global {
	    interface IFBinder {
...
declare module '@ailhc/dpctrl-fguicc' {
	...
	export class FLayer extends fairygui.GComponent implements layer.ILayer {
	    private _layerType;
	    private _layerMgr;
	    onInit(layerName: string, layerType: number, layerMgr: layer.IMgr<fairygui.GComponent>): void;
	    onDestroy(): void;
