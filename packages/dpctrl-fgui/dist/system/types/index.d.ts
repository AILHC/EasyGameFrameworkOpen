declare module '@ailhc/dpctrl-fgui' {
	 global {
	    /**
	     * 节点绑定工具
	     */
...
declare module '@ailhc/dpctrl-fgui' {
	import { BinderTool } from '@ailhc/dpctrl-fgui'; global {
	    interface IFBinder {
...
declare module '@ailhc/dpctrl-fgui' {
	import { BinderTool } from "./BinderTool"; global {
	    interface IFBinder {
	        ui: fairygui.GComponent;
	        name: string;
	        $options?: NodeBinder.IBindOption;
...
declare module '@ailhc/dpctrl-fgui' {
	export * from "./BinderInterfaces";
	export * from "./BinderTool";
	export * from "./FBinderTool";
	export * from "./fix-some-fgui";
	export * from "./fgui-dpctrl";
	export * from "./fgui-layer";
