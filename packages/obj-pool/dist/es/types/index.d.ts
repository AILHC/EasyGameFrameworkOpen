declare module '@ailhc/obj-pool/src/obj-pool' {
	export class BaseObjPool<T extends objPool.IObj = any, onGetDataType = any, SignType = any> implements objPool.IPool<T, onGetDataType, SignType> {
	    private _poolObjs;
	    private _usedObjMap;
...
declare module '@ailhc/obj-pool/src/obj-pool-mgr' {
...
declare module '@ailhc/obj-pool/src/obj-pool-interfaces' {
	 global {
	    namespace objPool {
...
declare module '@ailhc/obj-pool' {
	export * from '@ailhc/obj-pool/src/obj-pool';
	export * from '@ailhc/obj-pool/src/obj-pool-mgr';
	export * from '@ailhc/obj-pool/src/obj-pool-interfaces';
