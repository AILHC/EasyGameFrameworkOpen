var excel2all = (function (exports, os, xlsx, path, zlib, fs, crypto, mmatch, worker_threads) {
    'use strict';
...
}({}, os, xlsx, path, zlib, fs, crypto, mmatch, worker_threads));

    var globalTarget =window?window:global;
    globalTarget.excel2all?Object.assign({},globalTarget.excel2all):(globalTarget.excel2all = excel2all)
//# sourceMappingURL=excel2all.js.map
